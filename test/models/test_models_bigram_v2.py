...
# hyperparameters
batch_size = 32
block_size = 8  # maximun context length for prediction
max_iters = 3000
eval_interval = 300
learning_rate = 1e-3
...
class BigramLanguageModel(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        # Block
        x = self.sa_head(x)  # apply one head of self-attention. [x]_(B,T,C_e)
        x = self.ff_head(x)  # apply feed-forward. [x]_(B,T,C_e)
